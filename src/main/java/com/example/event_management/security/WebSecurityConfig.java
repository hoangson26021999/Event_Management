    ...
    protected void configure(HttpSecurity http) throws Exception {
        http    .csrf().disable()
                .authorizeRequests()
                    ...
                    .antMatchers("/" ,"/create_register","/create_speaker","/home/**","//cdn.ckeditor.com/4.18.0/standard/ckeditor.js","https://cdn.ckeditor.com/ckeditor5/34.0.0/classic/ckeditor.js","https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js","https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js" , "https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" , "https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js").permitAll() // Cho phép tất cả mọi người truy cập vào các địa chỉ này
